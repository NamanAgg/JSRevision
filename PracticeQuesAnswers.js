...
// ];
// // Only change code below this line
// var ratings = watchList.map(function (data) {
//     return {
//         title: data.Title,
...
//     }
// ];
// let filteredList = watchList.filter(function (data) {
//     return (data.imdbRating >= 8.0)
// });
// filteredList = filteredList.map(function (data) {
//     return {
//         title: data.Title,
//         rating: data.imdbRating
//     };
...
//     const posIntegers = arr.filter(num => {
//         return num >= 0 && Number.isInteger(num);
//     });
//     const sqrtIntegers = posIntegers.map(num => {
//         return num * num;
//     });
//     return sqrtIntegers;
// };
// const sqrtIntegers = squareList([-3, 4.8, 5, 3, -3.2]);
// console.log(sqrtIntegers);
...
// Fluffy
// Fluffy
//but acc to me here there should be undefined
